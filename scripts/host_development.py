...
def local_environment(stack):
    ...
    return {
        ...
        "DATABASE_URL": (
            ...
            + "/goalstats_user_py_local"
        ),
        "REDIS_URL": "redis://127.0.0.1:" + settings.get("LOCAL_REDIS_PORT", "56379") + "/0",
        "CACHE_KEY_PREFIX": "goalstats-user-py:local:v1",
        ...
        if container:
            if service == "postgres":
                ...
                if (
                    ...
                    or config.get("POSTGRES_DB") != "goalstats_user_py_local"
...
def test_providers():
    ...
    project = "goalstats-user-py-test-" + secrets.token_hex(12)
