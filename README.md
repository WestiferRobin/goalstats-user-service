...
This is the active GoalStats User service repository. Its current Item + Action
reference foundation derives from `template-goalstats-service` at frozen commit
`6600facf42ecf9a3431b44f5d19ff2ac2a3b0b07`. User/auth product behavior is future
work. User runtime identities and private configuration are authoritative here;
this repository does not own the canonical Template.
...
Before a foundation release: `make smoke`, `make certify-host`, and
