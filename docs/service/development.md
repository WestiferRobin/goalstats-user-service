...
| --- | --- | --- | --- |
| Project | `goalstats-user-py-local` | `goalstats-user-py-dev` | `goalstats-user-py-test-<random>` |
| APP_ENV | `local` | `dev` | `test` |
| Database | `goalstats_user_py_local` | `goalstats_user_py_dev` | `goalstats_test_runtime` |
...
| Cache prefix | `goalstats-user-py:local:v1` | `goalstats-user-py:dev:v1` | `goalstats-user-py:test:v1` |
...
Check that the name is your abandoned `goalstats-user-py-test-<random>` or
`goalstats-user-py-cert-<random>` run and is not active in another terminal.
